...
src_unpack() {
	...
	UNIPATCH_LIST_DEFAULT="${DISTDIR}/patch-${OKV}-xanmod${XANMOD_VERSION}.xz
		${FILESDIR}/1810_sched_proxy_yield_the_donor_task.patch"
	UNIPATCH_EXCLUDE="${UNIPATCH_EXCLUDE} 1*_linux-${KV_MAJOR}.${KV_MINOR}.*.patch 1810_sched_proxy_yield_the_donor_task.patch"
