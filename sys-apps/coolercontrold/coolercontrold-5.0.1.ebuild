...
SRC_URI="
	...
	https://gitlab.com/coolercontrol/coolercontrol/-/releases/${PV}/downloads/packages/coolercontrold-vendor-${PV}.tar.gz
	${CARGO_CRATE_URIS}
"
S="${WORKDIR}/${MY_P}/${PN}"
...
src_install() {
	dobin "$(cargo_target_dir)"/coolercontrold
